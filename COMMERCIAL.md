...
Enterprise and OEM tiers additionally include:
...
3. Provide network users access to source code (if modified)
4. Preserve copyright notices and license headers
...
A: Yes, evaluate under AGPL-3.0 terms. Contact us when ready for commercial use.

**Q: Do you offer custom development?**
A: Yes, Enterprise and OEM tiers include custom integration support.
