...
| ID | Task | Status |
|---|---|---|
| T001 | Record hypothesis, root cause, and pre-fix failing checks | done — both timeline and repeated-word regressions failed before the fix |
| T002 | Add sentence-local absolute chunk timeline regression tests | done |
| T003 | Implement monotonic sentence-local chunk timing | done |
| T004 | Make word wrapping honor absolute source offsets | done |
| T005 | Add the tab-focus setting schema, default, UI, persistence, sync, and reset | done |
