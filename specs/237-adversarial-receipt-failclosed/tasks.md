...
- [x] T1 Reproduce missing receipt reaching a fake model command
- [x] T2 Preserve every delivery-script command status before `readonly`
- [x] T3 Add fail-closed repo-wide static and isolated no-provider checks
