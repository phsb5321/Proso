...
- [ ] T002 Build unlisted and listed Firefox 1.2.10 artifacts from the isolated worktree; run the release-channel gate and Mozilla validator.
...
- [ ] T007A Cancel the unpublished 1.2.9 draft and submit the corrected 1.2.10 binary plus minimal, remotely reachable source closure.
