...
const baseAddon = {
  ...
  name: { 'en-US': 'Proso' },
  status: 'public',
  current_version: { version: '1.2.9', file: { status: 'public' } },
};
...
try {
  ...
  const failures = [
    ...
    { ...baseAddon, current_version: { version: '1.2.8', file: { status: 'public' } } },
    { ...baseAddon, current_version: { version: '1.2.9', file: { status: 'awaiting_review' } } },
    null,
  ];
